...
class YoutubeChannel {
  ...
  static async create(data) {
    ...
    return new Promise((resolve, reject) => {
      db.run(
        `INSERT INTO youtube_channels (id, user_id, channel_id, channel_name, channel_thumbnail, subscriber_count, access_token, refresh_token, client_id, client_secret, is_default)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
        [
          id,
          data.user_id,
